// components/footer/ProZonaFooter.tsx
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li><Link href="/privacy" className="hover:text-[#1DB954] transition-colors">Политика за поверителност</Link></li>
              <li><Link href="/terms" className="hover:text-[#1DB954] transition-colors">Общи условия</Link></li>
              <li><Link href="/cookies" className="hover:text-[#1DB954] transition-colors">Политика за бисквитки</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li>+359 883 202 922</li>
              <li>Видин, България</li>
            </ul>
          </div>
        </div>
