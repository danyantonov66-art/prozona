          ...
          <div className="w-full max-w-md rounded-2xl border border-white/10 bg-[#151528] p-6">
            ...
            {success ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <select name="city" value={form.city} onChange={handleChange} required className="w-full rounded-xl bg-[#0F1020] border border-white/10 px-4 py-3 text-white outline-none">
