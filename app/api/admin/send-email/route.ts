  ...
  try {
    ...
    if (type === "wrong_role") {
      await resend.emails.send({
        ...
        to,
        subject: "Регистриран си като клиент – искаш ли да станеш специалист?",
        html: `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #0D0D1A; color: #ffffff; padding: 40px; border-radius: 12px;">
            ...
            <p style="color: #cccccc; font-size: 16px; line-height: 1.6; margin-bottom: 16px;">
              Забелязахме, че си се регистрирал в <strong style="color: #1DB954;">ProZona</strong> като клиент.
            </p>
            <p style="color: #cccccc; font-size: 16px; line-height: 1.6; margin-bottom: 24px;">
              Ако си майстор или специалист и искаш да получаваш запитвания от клиенти, можеш да създадеш профил като специалист — <strong style="color: #1DB954;">безплатно</strong>.
            </p>
            <div style="background: #151528; border-radius: 12px; padding: 20px; margin-bottom: 24px;">
              <div style="display: flex; align-items: center; margin-bottom: 12px;">
                <span style="font-size: 18px; margin-right: 12px;">✅</span>
                <span style="color: #ffffff; font-size: 15px;">Безплатен старт — без абонамент</span>
              </div>
              <div style="display: flex; align-items: center; margin-bottom: 12px;">
                <span style="font-size: 18px; margin-right: 12px;">✅</span>
                <span style="color: #ffffff; font-size: 15px;">Реални запитвания от клиенти</span>
              </div>
              <div style="display: flex; align-items: center;">
                <span style="font-size: 18px; margin-right: 12px;">✅</span>
                <span style="color: #ffffff; font-size: 15px;">Без посредници — директен контакт</span>
              </div>
            </div>
            <div style="background: #1a2e1a; border-left: 4px solid #1DB954; padding: 12px 16px; margin-bottom: 24px; border-radius: 4px;">
              <p style="margin: 0; color: #cccccc;">
                🎁 Първите 200 специалисти получават <strong style="color: #1DB954;">6 месеца Premium безплатно</strong>!
              </p>
            </div>
            <div style="text-align: center; margin: 32px 0;">
              <a href="https://www.prozona.bg/bg/become-specialist"
    ...
    if (type === "offers_feature_announcement") {
      await resend.emails.send({
        from: "ProZona <office@prozona.bg>",
        to,
        subject: "Нова функция в ProZona: AI генератор на оферти",
        html: `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #0D0D1A; color: #ffffff; padding: 40px; border-radius: 12px;">
            <div style="text-align: center; margin-bottom: 32px;">
              <div style="display: inline-block; background: #1DB954; padding: 12px 24px; border-radius: 8px;">
