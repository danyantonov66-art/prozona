    ...
    <main className="min-h-screen bg-[#0D0D1A]">
      ...
      <section className="container mx-auto px-4 py-12">
        <div className="flex flex-wrap gap-4 justify-center">
          <Link href="/categories/construction" className="px-6 py-3 bg-[#1A1A2E] text-white rounded-full hover:bg-[#25253a] transition-colors">
            🔨 Строителство
          </Link>
          <Link href="/categories/home" className="px-6 py-3 bg-[#1A1A2E] text-white rounded-full hover:bg-[#25253a] transition-colors">
            🧹 Домашни услуги
          </Link>
          <Link href="/categories/beauty" className="px-6 py-3 bg-[#1A1A2E] text-white rounded-full hover:bg-[#25253a] transition-colors">
            💅 Красота
          </Link>
          <Link href="/categories/photography" className="px-6 py-3 bg-[#1A1A2E] text-white rounded-full hover:bg-[#25253a] transition-colors">
            📸 Фотография
          </Link>
          <Link href="/specialists" className="px-6 py-3 bg-[#1DB954] text-white rounded-full hover:bg-[#169b43] transition-colors">
            Всички категории →
          </Link>
        </div>
      </section>
      ...
      <section className="container mx-auto px-4 py-12">
        <div className="flex justify-between items-center mb-8">
          ...
          <Link href="/specialists" className="text-[#1DB954] hover:underline text-lg">
            Виж всички →
          </Link>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
